...
const TypedQ trans_p11[] = {
    ...
    {"wo", "kde|where", "kde"},
    {"wohnen (Infinitiv), er wohnt", "bydlet|bydlí|to live", "bydlet"},
    {"Wo wohnst du?",
...
const TypedQ trans_p13[] = {
    ...
    {"chatten (Infinitiv), er chattet", "chatovat|chatuje|to chat", "chatovat"},
    ...
    {"gehen (Infinitiv), er geht", "jít|jde|chodit|to go", "jít"},
    ...
    {"hören (Infinitiv), er hört", "poslouchat|poslouchá|slyšet|to listen|to hear",
     "poslouchat"},
    {"Er hört gern Musik.", "rád poslouchá hudbu|he likes listening to music",
     "Rád poslouchá hudbu."},
    {"im Internet surfen (Infinitiv), er surft im Internet",
    ...
    {"lernen (Infinitiv), er lernt", "učit se|učí se|to learn", "učit se"},
    {"liegen (Infinitiv), er liegt", "ležet|leží|to lie|to be located", "ležet"},
    {"der Nachname, -n", "příjmení|surname|last name", "příjmení"},
    {"nicht weit von", "nedaleko od|not far from", "nedaleko od"},
    {"reisen (Infinitiv), er reist", "cestovat|cestuje|to travel", "cestovat"},
    {"schreiben (Infinitiv), er schreibt", "psát|píše|to write", "psát"},
    {"die Schule, -n", "škola|school", "škola"},
    {"spielen (Infinitiv), er spielt", "hrát|hraje|to play", "hrát"},
    {"Sie spielt Gitarre.", "hraje na kytaru|she plays the guitar",
     "Hraje na kytaru."},
    {"tanzen (Infinitiv), er tanzt", "tancovat|tančí|tancuje|to dance", "tancovat"},
