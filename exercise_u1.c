...
const TypedQ trans_p11[] = {
    ...
    {"wo", "kde|where", "kde"},
    {"wohnen, er wohnt", "bydlet|bydlí|to live", "bydlet"},
    {"Wo wohnst du?",
...
const TypedQ trans_p13[] = {
    ...
    {"chatten, er chattet", "chatovat|chatuje|to chat", "chatovat"},
    ...
    {"gehen, er geht", "jít|jde|chodit|to go", "jít"},
    ...
    {"hören, er hört", "poslouchat|poslouchá|slyšet|to listen|to hear",
     "poslouchat"},
    ...
    {"lernen, er lernt", "učit se|učí se|to learn", "učit se"},
    {"liegen, er liegt", "ležet|leží|to lie|to be located", "ležet"},
    {"der Nachname, -n", "příjmení|surname|last name", "příjmení"},
    {"nicht weit von", "nedaleko od|not far from", "nedaleko od"},
    {"reisen, er reist", "cestovat|cestuje|to travel", "cestovat"},
    {"schreiben, er schreibt", "psát|píše|to write", "psát"},
    {"die Schule, -n", "škola|school", "škola"},
    {"spielen, er spielt", "hrát|hraje|to play", "hrát"},
    {"Sie spielt Gitarre.", "hraje na kytaru|she plays the guitar",
     "Hraje na kytaru."},
    {"tanzen, er tanzt", "tancovat|tančí|tancuje|to dance", "tancovat"},
