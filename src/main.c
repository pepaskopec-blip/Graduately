...
void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_stack_add_named(main_stack, build_cetba_fuks_plot_page(),
                        "cetbaFuksDej");
    gtk_stack_add_named(main_stack, build_cetba_stub_page(), "cetbastub");
    gtk_stack_add_named(main_stack, build_cetba_stub_quiz_page(),
                        "cetbastubquiz");
    gtk_stack_add_named(main_stack, build_cetba_stub_plot_page(),
                        "cetbastubdej");
